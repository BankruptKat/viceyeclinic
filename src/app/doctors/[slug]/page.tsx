...
export async function generateStaticParams() {
    return doctorsData.map((doctor: { slug: string }) => ({
        slug: doctor.slug,
    }));
}
...
export async function generateMetadata(
    ...
    const doctor = doctorsData.find((d: { slug: string; name: string; bio: string[] }) => d.slug === resolvedParams.slug);
...
export default async function DoctorProfilePage({ params }: Props) {
    ...
    const doctor = doctorsData.find((d: { slug: string;[key: string]: any }) => d.slug === resolvedParams.slug);
